...
1. Deploy the cluster ARM template.
   ...
   > Alternatively, you could have updated the [`azuredeploy.parameters.prod.bicepparam`](../../workload-team/cluster/azuredeploy.parameters.prod.bicepparam) file and deployed as above, using `-p "@azuredeploy.parameters.prod.bicepparam"` instead of providing the individual key-value pairs.
