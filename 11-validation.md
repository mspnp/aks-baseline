...
1. Get the public IP address of Application Gateway.
   ...
   APPGW_PUBLIC_IP_AKS_BASELINE=$(az deployment group show --resource-group rg-enterprise-networking-spokes -n spoke-BU0001A0008 --query properties.outputs.appGwPublicIpAddress.value -o tsv)
