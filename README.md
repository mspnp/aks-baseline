...
![Network diagram depicting a hub-spoke network with two peered VNets, each with three labeled subnets.](https://docs.microsoft.com/azure/architecture/reference-architectures/containers/aks/secure-baseline/_images/baseline-network-topology.png)
