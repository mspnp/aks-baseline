...
./1-cluster-stamp.sh $LOCATION $RGNAMECLUSTER1 $RGNAMECLUSTER2 $RGNAMESPOKES $TENANTID_K8SRBAC $MAIN_SUBSCRIPTION $RESOURCE_ID_VNET1 $RESOURCE_ID_VNET2 $AADOBJECTID_GROUP_CLUSTERADMIN $K8S_RBAC_AAD_PROFILE_TENANTID $AKS_ENDUSER_NAME $AKS_ENDUSER_PASSWORD $RGNAME_FRONT_DOOR $CLUSTER_SUBDOMAIN1 $CLUSTER_SUBDOMAIN2
