...
- [`hub-regionA.bicep`](./hub-regionA.bicep) is a file that defines a specific region's hub (for example, it might be named `hub-eastus.bicep`). This is the long-lived template that defines this specific region's hub.
